import{S as e}from"./index-CZTiS8Sn.js";const t="decalFragmentDeclaration",w=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=w);const o="prePassDeclaration",D=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=D);const i="oitDeclaration",X=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=L);const n="shadowsFragmentFunctions",E=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=E);const l="samplerFragmentDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=T);const d="reflectionFunction",I=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=I);const f="imageProcessingDeclaration",A=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=A);const c="imageProcessingFunctions",P=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=P);const h="bumpFragmentMainFunctions",M=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=M);const v="bumpFragmentFunctions",F=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=F);const u="bumpFragment",y=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=y);const p="decalFragment",N=`#ifdef DECAL
#ifdef GAMMADECAL
...
//# sourceMappingURL=oitFragment-DY61I6kU.js.map
